...
//! | [`edge`]  | 1-D/2-D subpixel edge (DoG / Scharr) detection, edgels, edge-pairs |
...
pub use core::{
    ...
    map_index, sample_bilinear_f32, sample_nearest, to_f32, to_f32_u16, to_na_point, to_na_vec,
    wrap_angle,
};
pub use edge::{
    DoGKernel1D, Edge1DConfig, Edge1DDetector, Edge2DConfig, Edge2DDetector, EdgePair1D,
    EdgePairConfig, EdgePeak, EdgePolarity, Edgel, GradientBuffers, SmoothKind, Subpix2D,
    SubpixRefine, best_edge_pair, best_edge_pair_in_row_u8,
};
pub use morph::{
