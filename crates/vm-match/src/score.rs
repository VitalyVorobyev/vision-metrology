...
use vm_core::{ImageView, Point2f, Vec2f};
...
pub fn build_scene_chamfer(scene_edgels: &[Edgel], w: usize, h: usize) -> vm_core::Image<f32> {
    use vm_morph::chamfer_distance_u8;
    ...
    let mask_img = vm_core::Image::from_vec(w, h, mask).expect("valid dims");
