...
//! # Example
//! ```rust
//! use vm_shape::{ConicFitter, ConicFitConfig, Ellipse2f};
...
use crate::fit_conic::{fit_bookstein, fit_fitzgibbon};
use crate::ransac::ransac_fit_ellipse;
